...
const account1 = {
  ...
  movementsDates: [
    ...
    "2025-10-28T09:15:04.904Z",
    "2025-10-01T10:17:24.185Z",
    "2025-10-08T14:11:59.604Z",
    "2025-10-27T17:01:17.194Z",
    "2025-10-06T23:36:17.929Z",
    "2025-10-10T10:51:36.790Z",
  ],
  currency: "EUR",
  locale: "pt-PT",
};
...
btnLogin.addEventListener("click", function (e) {
  ...
  if (currentAccount?.pin === Number(inputLoginPin.value)) {
    ...
    //Started the logout timer to logout the user afte a certain time of login
    if (timer) clearInterval(timer); //Resetting any previous timer after login to another account
...
btnLoan.addEventListener("click", function (e) {
  ...
  //Taking loan takes some time--- so settimeout
  if (
    amount > 0 &&
